...
name: release
description: >
  Coordinate a full FideliOS release across engineering verification, npm,
...
Run the full FideliOS maintainer release workflow, not just an npm publish.
...
7. If running through FideliOS, you have issue context for status updates and follow-up task creation.
...
FideliOS now uses a commit-driven release model:
...
npm view fidelios@canary version
```
...
- release summary in FideliOS issue context
