...
This is intentionally separate from the normal FideliOS dev image.
...
## Preview the FideliOS app from the PR
...
- FideliOS's embedded PostgreSQL and local storage stay inside the container home volume via `FIDELIOS_HOME=/home/reviewer/.fidelios-review`.
