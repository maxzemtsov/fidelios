...
- installed adapter list for this FideliOS instance
...
## 8. New Skill: `fidelios-create-agent`

Create new skill directory:

- `skills/fidelios-create-agent/SKILL.md`
...
Also update `skills/fidelios/SKILL.md` to reference this skill for hiring workflows.
...
- `fidelios-create-agent` skill + docs updates
