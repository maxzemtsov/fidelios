...
- `skills/fidelios/SKILL.md` and `skills/fidelios/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/fidelios-create-agent/SKILL.md`
