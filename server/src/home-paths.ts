...
export function resolveFideliOSInstanceRoot(): string {
  return path.resolve(resolveFideliOSHomeDir(), "instances", resolveFideliOSInstanceId());
}

export function resolveDefaultConfigPath(): string {
  return path.resolve(resolveFideliOSInstanceRoot(), "config.json");
}

export function resolveDefaultEmbeddedPostgresDir(): string {
  return path.resolve(resolveFideliOSInstanceRoot(), "db");
}

export function resolveDefaultLogsDir(): string {
  return path.resolve(resolveFideliOSInstanceRoot(), "logs");
}

export function resolveDefaultSecretsKeyFilePath(): string {
  return path.resolve(resolveFideliOSInstanceRoot(), "secrets", "master.key");
}

export function resolveDefaultStorageDir(): string {
  return path.resolve(resolveFideliOSInstanceRoot(), "data", "storage");
}

export function resolveDefaultBackupDir(): string {
  return path.resolve(resolveFideliOSInstanceRoot(), "data", "backups");
}
...
export function resolveDefaultAgentWorkspaceDir(agentId: string): string {
  ...
  return path.resolve(resolveFideliOSInstanceRoot(), "workspaces", trimmed);
}
