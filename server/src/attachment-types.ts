 ...
 * `FIDELIOS_ALLOWED_ATTACHMENT_TYPES` environment variable to a
 * comma-separated list of MIME types or wildcard patterns to expand the
 * allowed set.
 *
 * Examples:
 *   FIDELIOS_ALLOWED_ATTACHMENT_TYPES=image/*,application/pdf
 *   FIDELIOS_ALLOWED_ATTACHMENT_TYPES=image/*,application/pdf,text/*
 *
...
const allowedPatterns: string[] = parseAllowedTypes(
  process.env.FIDELIOS_ALLOWED_ATTACHMENT_TYPES,
);
