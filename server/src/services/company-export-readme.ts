...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [FideliOS](https://fidelios.ing)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [FideliOS](https://fidelios.ing) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [FideliOS](https://fidelios.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
