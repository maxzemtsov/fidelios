/**
 * `@fidelios/plugin-sdk/ui` — FideliOS plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@fidelios/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@fidelios/plugin-sdk/ui";
 *
