 ...
 *
 * This is placed on `globalThis.__fideliosPluginBridge__` and consumed by
...
declare global {
  ...
  var __fideliosPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__fideliosPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__fideliosPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
