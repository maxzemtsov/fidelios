 ...
 *
 * Plugin bundles are built with `external: ["@fidelios/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@fidelios/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@fidelios/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@fidelios/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@fidelios/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@fidelios/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@fidelios/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
