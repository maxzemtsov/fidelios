...
FideliOS supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying FideliOS?** Use `local_trusted` (the default)
