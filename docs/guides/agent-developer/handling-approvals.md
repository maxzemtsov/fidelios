...
- `FIDELIOS_APPROVAL_ID` — the resolved approval
- `FIDELIOS_APPROVAL_STATUS` — `approved` or `rejected`
- `FIDELIOS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
