...
Eval framework for testing FideliOS agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the FideliOS heartbeat skill:
